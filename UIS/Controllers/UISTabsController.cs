...
namespace UISTabs.Controllers
{
    public class UISTabsController : Controller
    {
        private readonly ILogger<UISTabsController> _logger;

        public UISTabsController(ILogger<UISTabsController> logger)
        {
            _logger = logger;
        }
